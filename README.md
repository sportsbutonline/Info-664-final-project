...
Once the new dataset was imported I used ==pandas== and ==matplotlib.pyplot== libraries to work with the dataset and visualize differnt columns into a pie chart showing differnt mediums within the vase collection. 
